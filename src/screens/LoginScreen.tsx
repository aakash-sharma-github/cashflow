    ...
    <View style={styles.root}>
      ...
      >
        <View style={[styles.card, { backgroundColor: theme.background }]}>
          ...
          {/* Email input */}
          <View style={[styles.inputWrap, { backgroundColor: theme.surface, borderColor: theme.border }, emailFocused && styles.inputWrapFocused]}>
            <Ionicons
              name="mail-outline"
              size={18}
          ...
          <View style={styles.disclaimerRow}>
            <Text style={[styles.disclaimer, { color: theme.textTertiary }]}>By continuing you agree to our </Text>
            <TouchableOpacity onPress={() => navigation.navigate('Terms')} activeOpacity={0.7}>
              <Text style={styles.disclaimerLink}>Terms</Text>
            </TouchableOpacity>
            <Text style={[styles.disclaimer, { color: theme.textTertiary }]}> &amp; </Text>
...
const styles = StyleSheet.create({
  ...
  disclaimerRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', flexWrap: 'wrap', marginTop: 4 },
