...
export default function LoginScreen({ navigation }: any) {
  ...
  const handleGoogle = async () => {
    ...
    if (error && error !== 'cancelled') Alert.alert('Google Sign-In Failed', error)
  }
...
const styles = StyleSheet.create({
  ...
  circle2: { position: 'absolute', width: 140, height: 140, borderRadius: 70, backgroundColor: 'rgba(255,255,255,0.05)', top: 40, right: 60 },
  circle3: { position: 'absolute', width: 100, height: 100, borderRadius: 50, backgroundColor: 'rgba(255,255,255,0.06)', bottom: 80, left: -20 },
  ...
  appName: { fontSize: FONT_SIZE['2xl'], fontWeight: '800', color: '#fff', letterSpacing: -0.5, marginBottom: 6 },
  tagline: { fontSize: FONT_SIZE.md, color: 'rgba(255,255,255,0.8)', lineHeight: 22 },
  ...
  cardTitle: { fontSize: FONT_SIZE['2xl'], fontWeight: '800', color: COLORS.text, marginBottom: 4 },
  cardSub: { fontSize: FONT_SIZE.sm, color: COLORS.textSecondary, marginBottom: SPACING.xl },
  ...
  dividerText: { fontSize: FONT_SIZE.xs, color: COLORS.textTertiary, fontWeight: '500' },
  ...
  otpBtn: { borderRadius: BORDER_RADIUS.md, overflow: 'hidden', marginBottom: SPACING.md, ...SHADOW.md },
  btnDisabled: { opacity: 0.65 },
  otpBtnGradient: {
    flexDirection: 'row', alignItems: 'center', justifyContent: 'center',
    paddingVertical: 15, gap: SPACING.sm,
  },
  otpBtnText: { fontSize: FONT_SIZE.md, fontWeight: '700', color: '#fff', letterSpacing: 0.3 },

  disclaimer: { fontSize: FONT_SIZE.xs, color: COLORS.textTertiary, textAlign: 'center', lineHeight: 18 },
