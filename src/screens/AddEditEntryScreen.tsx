...
export default function AddEditEntryScreen({ route, navigation }: any) {
  ...
  const [iosPickerTarget, setIosPickerTarget] = useState<"date" | "time">(
    "date",
  );
      ...
      >
        ...
        <View style={s.dateTimeRow}>
          <TouchableOpacity
            ...
            onPress={() =>
              Platform.OS === "ios" ? openIos("date") : openAndroid("date")
            }
            activeOpacity={0.8}
          >
            <Ionicons
            ...
            />
            <View>
              <Text style={[s.dateTimeLabel, { color: theme.textTertiary }]}>
                Date
              </Text>
              <Text style={[s.dateTimeVal, { color: theme.text }]}>
                {dateLabel}
              </Text>
            </View>
            <Ionicons
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              Platform.OS === "ios" ? openIos("time") : openAndroid("time")
            }
            activeOpacity={0.8}
          >
        ...
        <View
          style={[
            s.amountWrap,
            { borderColor: amountBorderColor, backgroundColor: theme.surface },
          ]}
        >
          ...
          <View style={s.amountRow}>
            <Text style={[s.currencyPrefix, { color: amountColor }]}>
              {symbol}{" "}
            </Text>
            <TextInput
        ...
        <View style={s.typeRow}>
          <TouchableOpacity
            style={[
              ...
              isCashIn && {
                ...
                backgroundColor: COLORS.cashInDark,
              },
            ]}
          ...
          >
            <Ionicons
              name="add"
              size={14}
              color={isCashIn ? COLORS.cashIn : theme.textTertiary}
            />
            <Text
              style={[
                s.typeBadgeText,
          ...
          <TouchableOpacity
            style={[
              ...
              !isCashIn && {
                ...
                backgroundColor: COLORS.cashOutDark,
              },
            ]}
          ...
          >
            <Ionicons
              name="remove"
              size={14}
              color={!isCashIn ? COLORS.cashOut : theme.textTertiary}
            />
            <Text
              style={[
                s.typeBadgeText,
        ...
        >
          <View style={s.notesHeader}>
            <Ionicons
              ...
              color={theme.textTertiary}
            />
            <Text style={[s.notesLabel, { color: theme.textTertiary }]}>
              Notes (optional)
            </Text>
          </View>
          <TextInput
            ...
            placeholder="Add a note, remark or description..."
          ...
          <View style={[s.sheet, { backgroundColor: theme.surface }]}>
            <View style={[s.sheetHeader, { borderBottomColor: theme.border }]}>
              <TouchableOpacity onPress={() => setIosVisible(false)}>
                <Text style={[s.sheetCancel, { color: theme.textSecondary }]}>
                  Cancel
                </Text>
              </TouchableOpacity>
              ...
              >
                <Text style={[s.sheetDone, { color: COLORS.primary }]}>
                  Done
                </Text>
              </TouchableOpacity>
            </View>
...
const s = StyleSheet.create({
  ...
  notesLabel: { fontSize: FONT_SIZE.xs, fontWeight: "600" },
  remarkInput: {
    flex: 1,
